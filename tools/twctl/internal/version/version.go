...
// BuildVersion is the version of twctl.
const BuildVersion = "1.0.0"

var tag = map[string]int{"pre-alpha": 0, "alpha": 1, "pre-beta": 2, "beta": 3, "released": 4, "": 5}

// GettwctlVersion returns BuildVersion
func GettwctlVersion() string {
	return BuildVersion
}

// IsVersionGreaterThan compares whether the current twctl version
...
func IsVersionGreaterThan(version, target string) bool {
	...
	if versionNumber > targetVersionNumber {
		...
		// unchecked case, in normal, the twctl version does not contain suffix in release.
