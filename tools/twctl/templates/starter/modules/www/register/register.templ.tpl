	...
	@sitelayout.New(
		...
		<div class="flex flex-col items-center justify-center h-full">
			<div class="w-full max-w-sm p-4 bg-white border rounded-lg shadow border-slate-200 sm:p-6 md:p-8 dark:bg-slate-800 dark:border-slate-700">
				<form class="max-w-md mx-auto space-y-4" hx-post="/register" hx-target="#form-error" hx-swap="innerHTML" hx-on::after-request="this.reset()">
...
templ Error(str string) {
	<div role="alert" class="alert alert-error">
		<svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 stroke-current shrink-0" fill="none" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
		<span>Error! { str }</span>
	</div>
}
